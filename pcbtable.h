...
private:
  ...
  vector<PCB*> table; //created a vector for PCB's for my datatype I choose this datatype because we don't know what  the size of the table will be and vectors don't have a static size
public:
    /**
